...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const extraVideos = [
    {id:'ex1', cat:'smart-rings', badge:'SMART RINGS', date:'Aug 02, 2026', title:'Oura vs Ultrahuman Sleep Test', excerpt:'30 nights, two rings, one winner.', src:'https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4'},
    {id:'ex2', cat:'meta-smart-glasses', badge:'META GLASSES', date:'Jul 28, 2026', title:'14 Days Living in Ray-Ban Meta', excerpt:'What strangers think when you record.', src:'https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4'},
    {id:'ex3', cat:'smartwatches', badge:'SMARTWATCHES', date:'Jul 14, 2026', title:'Best Running Watches 2026', excerpt:'GPS lock and HR accuracy ranked.', src:'https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4'},
    {id:'ex4', cat:'smart-rings', badge:'SMART RINGS', date:'Jul 01, 2026', title:'RingConn Gen 2 No Subscription', excerpt:'Bigger sizes, but does it last?', src:'https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4'},
